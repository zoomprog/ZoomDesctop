...
"pading-bottom:7px;")
    ...
    def retranslateUi(self, Ui_Reg):
        ...
        self.pushUrlDiscord.setText(_translate("Ui_Reg", "Y"))
        self.pushUrlGitHub.setText(_translate("Ui_Reg", ")"))
        self.pushUrlFacebook.setText(_translate("Ui_Reg", "E"))
        self.pushUrlYouTube.setText(_translate("Ui_Reg", "P"))
